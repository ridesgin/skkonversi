...
$sql = $connect->query("SELECT * FROM konversi where id_pengantar = ".$_GET['id_pengantar']);
				...
				<div class="collapse show" id="demo1">
					<div class="card">
						<div class="card-block container">
							<table class="table-sm">
								...
								<tr>
									...
									<td><input type="text" class="form-control form-control-sm col-4 <?php echo $vali1 ?>" name="no_surat" value="<?php echo $no_surat ?>" readonly></td>
								</tr>
								<tr>
									<th width="30%">Kode Tamu</th>
									<td><input type="text" class="form-control form-control-sm col-4 <?php echo $vali2; ?>" name="kode_tamu" value="<?php echo $kode_tamu ?>" readonly></td>
								</tr>
								<tr>
									<th>NIP</th>
									<td><input type="text" minlength="18" required title="Minimal 18 karakter" maxlength="18" pattern="^[0-9]{18,18}$" class="form-control form-control-sm col-md-5" onkeyup="isi_otomatis()" name="nip" id="nip" pattern=".{18,}" required title="Minimal 18 karakter" maxlength="18" autofocus placeholder="NIP"></td>
								</tr>
								<tr>
						...
						<div class="card-footer">
							...
							<div class="float-right" style="font-size: 1.2em">Jumlah data konversi <div class="badge badge-pill badge-success"><?php echo $data ?></div> dari <div class="badge badge-pill badge-primary"><?php echo $limit ?></div> usulan untuk No. Surat <?php echo $ambil['no_surat'] ?></div>
						</div>
					</div>
				</div>
			</div>
